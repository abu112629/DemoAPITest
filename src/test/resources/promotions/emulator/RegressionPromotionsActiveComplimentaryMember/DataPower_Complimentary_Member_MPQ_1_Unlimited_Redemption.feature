Feature: Verify All Clubs , ACTIVE COMPLIMENTARY Member , MPQ - 1, Unlimited Redemption,2$ Off each for DataPower InstantSavings: Buy X get $Y off on X

@Regression
  Scenario Outline: DataPower QuickSilver Promos for Regular Mix and Match Single Order Lines for Promo Item 622943 with ACTIVE COMPLIMENTARY Member
    Given Minimum <Quantity> required for DataPower with <Channel>,<ItemId>,<ClubId> and <ChannelCode> with <RetailPrice> and Single OrderLine <OrderLines> in <Applied_Dates> to be Utilised to Get Offer <Offer Id> for complimentary member
...
@Regression
  Scenario Outline: DataPower QuickSilver Promos for Regular Mix and Match Double Order Lines for Promo Item 622943 and 984102 with ACTIVE COMPLIMENTARY Member
    Given Minimum <Quantity> required for DataPower with <Channel>,<ItemId>,<ClubId> and <ChannelCode> with <RetailPrice> and Single OrderLine <OrderLines> in <Applied_Dates> to be Utilised to Get Offer <Offer Id> for complimentary member
    Given Minimum <Quantity2> required for DataPower with Second <ItemId2> and <ClubId> with <RetailPrice> and Second OrderLine <SecondOrderLine> to be Utilised to Get Offer for Complimentary Member
    When Post request to DataPower Endpoint for Complimentary Member
    When Request posted to DataPower and get the required discount for Complimentary Member
    Then Assert required to DataPower and get attributes for Complimentary Member
      | Offer Description   | GS1Code   | Offer Id   | Gtin   | Discount   |
    ...
    Examples: 
      ...
      |        2 | 622943 |           2 |        3500 |   4969 |          1 | DOTCOM  |               2 |  984102 |         2 | IS Item$Dis       | 0000000001111 |    26293 | 779240 |      800 | MIDDLE_DATE   |
      |        3 | 622943 |           2 |        4000 |   4969 |          1 | DOTCOM  |               2 |  984102 |         3 | IS Item$Dis       | 0000000001111 |    26293 | 779240 |     1200 | LAST_DATE     |
      |        1 | 622943 |           3 |        3000 |   4969 |          1 | DOTCOM  |               2 |  984102 |         1 | IS Item$Dis       | 0000000001111 |    26293 | 779240 |      400 | FIRST_DATE    |
      |        2 | 622943 |           3 |        3500 |   4969 |          1 | DOTCOM  |               2 |  984102 |         2 | IS Item$Dis       | 0000000001111 |    26293 | 779240 |      800 | MIDDLE_DATE   |
      |        3 | 622943 |           3 |        4000 |   4969 |          1 | DOTCOM  |               2 |  984102 |         3 | IS Item$Dis       | 0000000001111 |    26293 | 779240 |     1200 | LAST_DATE     |
