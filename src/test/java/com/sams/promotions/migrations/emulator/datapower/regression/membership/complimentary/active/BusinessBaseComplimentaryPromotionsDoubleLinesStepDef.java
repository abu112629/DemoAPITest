  ...
  public class BusinessBaseComplimentaryPromotionsDoubleLinesStepDef extends
  BaseStep {
  ...
  membershipNbr,complimentarymembershipNbr; protected Response
  ...
  public BusinessBaseComplimentaryPromotionsDoubleLinesStepDef() throws
  IOException { super(); }
  ...
  ) public void createthesingleLineRequestBusinessComplimentaryBase(String
  ...
  UpdatetheRequesttoDoubleLinesBusinessComplimentaryBase(ClubId, ClubId2,
  ...
  public void UpdatetheRequesttoDoubleLinesBusinessComplimentaryBase(String
  ClubId, String ClubId2, int RetailPrice, String lineNumber, String
  Applied_Dates) throws Exception {
  
  postDoubleRequestDetails=primaryrequest.getBusinessBasePostRequestDetails(
  ...
  ) public void ChecktheResultsdoubleLinesBusinessComplimentaryBase() throws
  Exception {
  
  softAssertions=asserthelper.BusinessBaseDoubleLinesValidation(response,
