  ...
  public class SavingsPlusComplimentaryPromotionsDoubleLinesStepDef extends
  BaseStep {
  ...
  public SavingsPlusComplimentaryPromotionsDoubleLinesStepDef() throws
  IOException { super(); }
  ...
  @Given("^DataPower with (.*),(\\d+),(\\d+) and (\\d+) with (\\d+) and Single OrderLine (\\d+) and Double Order Line (\\d+) in (.*) to be Utilised to Get Offer for Savings Plus Complimentary Member$"
  ) public void createthesingleLineRequestSavingsPlusComplimentary(String
  ...
  UpdatetheRequesttoDoubleLinesSavingsPlusComplimentary(ClubId, ClubId2,
  RetailPrice, lineNumber2, Applied_Dates);
  
  POST_the_request_for_Double_linesSavingsPlusComplimentary();
  Getparameter_and_postOperation_for_Double_LinesSavingsPlusComplimentary();
  
  POST_the_emulator_request_for_Double_linesSavingsPlusComplimentary();
  Getemulatorparameter_and_postOperation_for_Double_linesSavingsPlusComplimentary
  ();
  
  ChecktheResultsdoubleLinesSavingsPlusComplimentary();
  ...
  @Given("^DataPower with Second Item and (\\d+),(\\d+) with (\\d+) and Second OrderLine (\\d+) in (.*) to be Utilised to Get Offer for Savings Plus Complimentary Member$"
  )
  
  public void UpdatetheRequesttoDoubleLinesSavingsPlusComplimentary(String
  ...
  @When("^DataPower Endpoint POST request for Savings Plus Complimentary Member$"
  ) public void POST_the_request_for_Double_linesSavingsPlusComplimentary() {
  ...
  @When("^Post the request to Emulator Endpoint for Savings Plus Complimentary Member$"
  ) public void
  POST_the_emulator_request_for_Double_linesSavingsPlusComplimentary() {
  ...
  @When("^Response for DataPower and get the required discount for Savings Plus Complimentary Member$"
  ) public void
  Getparameter_and_postOperation_for_Double_LinesSavingsPlusComplimentary() {
  ...
  @When("^Response for Emulator and get the required discount for Savings Plus Complimentary Member$"
  ) public void
  Getemulatorparameter_and_postOperation_for_Double_linesSavingsPlusComplimentary
  () {
  ...
  @Then("^Assert on DataPower request and get attributes for Savings Plus Complimentary Member$"
  ) public void ChecktheResultsdoubleLinesSavingsPlusComplimentary() throws
  Exception {
  
  softAssertions=asserthelper.SavingsPlusDoubleLinesValidation(response,
