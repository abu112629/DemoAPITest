...
public class SavingsPlusComplimentaryPromotionsDoubleLinesStepDef extends BaseStep {
	...
	public SavingsPlusComplimentaryPromotionsDoubleLinesStepDef() throws IOException {
		super();
	}
	...
	public void createthesingleLineRequestSavingsPlusComplimentary(String channelName, String ClubId, String ClubId2, int code,
		...
		while (i < size) {
			...
			UpdatetheRequesttoDoubleLinesSavingsPlusComplimentary(ClubId, ClubId2, RetailPrice, lineNumber2, Applied_Dates);
	...
	public void UpdatetheRequesttoDoubleLinesSavingsPlusComplimentary(String ClubId, String ClubId2, int RetailPrice,
	...
	public void POST_the_emulator_request_for_Double_linesSavingsPlusComplimentary() {
	...
	public void Getparameter_and_postOperation_for_Double_LinesSavingsPlusComplimentary() {
	...
	public void Getemulatorparameter_and_postOperation_for_Double_linesSavingsPlusComplimentary() {
	...
	public void ChecktheResultsdoubleLinesSavingsPlusComplimentary() throws Exception {
