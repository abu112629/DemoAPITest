...
public class BusinessBaseComplimentaryPromotionsStepDef extends BaseStep {
	...
	public BusinessBaseComplimentaryPromotionsStepDef() throws IOException {
		super();
	}
	...
	@Given("^Minimum required for DataPower with (.*),(\\d+),(\\d+) and (\\d+) with (\\d+) and Single OrderLine (\\d+) in (.*) to be Utilised to Get Offer for Business Base Complimentary Member$")
	public void createtheRequestBusinessComplimentaryBase(String channelName, String ClubId, String ClubId2, int code, int RetailPrice,
		...
		while (i < size) {
			...
			POST_the_requestBusinessComplimentaryBase();
			Getparameter_and_postOperationBusinessComplimentaryBase();

			POST_the_emulator_requestBusinessComplimentaryBase();
			Getemulatorparameter_and_postOperationBusinessComplimentaryBase();

			ChecktheResultsBusinessComplimentaryBase();
	...
	public void POST_the_emulator_requestBusinessComplimentaryBase() {
	...
	public void Getparameter_and_postOperationBusinessComplimentaryBase() {
	...
	public void Getemulatorparameter_and_postOperationBusinessComplimentaryBase() {
	...
	public void ChecktheResultsBusinessComplimentaryBase() throws Exception {
