...
public class BusinessPlusAddOnPromotionsDoubleLinesStepDef extends BaseStep {
	...
	public BusinessPlusAddOnPromotionsDoubleLinesStepDef() throws IOException {
		super();
	}
	...
	@Given("^DataPower with (.*),(\\d+),(\\d+) and (\\d+) with (\\d+) and Single OrderLine (\\d+) and Double Order Line (\\d+) in (.*) to be Utilised to Get Offer for Business Plus AddOn Member$")
	public void createthesingleLineRequestBusinessPlusAddOn(String channelName, String ClubId, String ClubId2, int code,
		...
		while (i < size) {
			...
			UpdatetheRequesttoDoubleLinesBusinessPlusAddOn(ClubId, ClubId2, RetailPrice, lineNumber2, Applied_Dates);

			POST_the_request_for_Double_linesBusinessPlusAddOn();
			Getparameter_and_postOperation_for_Double_LinesBusinessPlusAddOn();

			POST_the_emulator_request_for_Double_linesBusinessPlusAddOn();
			Getemulatorparameter_and_postOperation_for_Double_linesBusinessPlusAddOn();

			ChecktheResultsdoubleLinesBusinessPlusAddOn();
	...
	@Given("^DataPower with Second Item and (\\d+),(\\d+) with (\\d+) and Second OrderLine (\\d+) in (.*) to be Utilised to Get Offer for Business Plus AddOn Member$")

	public void UpdatetheRequesttoDoubleLinesBusinessPlusAddOn(String ClubId, String ClubId2, int RetailPrice,
	...
	public void POST_the_request_for_Double_linesBusinessPlusAddOn() {
	...
	public void POST_the_emulator_request_for_Double_linesBusinessPlusAddOn() {
	...
	public void Getparameter_and_postOperation_for_Double_LinesBusinessPlusAddOn() {
	...
	public void Getemulatorparameter_and_postOperation_for_Double_linesBusinessPlusAddOn() {
	...
	public void ChecktheResultsdoubleLinesBusinessPlusAddOn() throws Exception {
