...
public class SavingsBasePromotionsDoubleLinesStepDef extends BaseStep {
	...
	public void createthesingleLineRequest(String channelName, String ClubId, String ClubId2, int code, int RetailPrice,
		...
		while (i < size) {
			...
			UpdatetheRequesttoDoubleLines(ClubId, ClubId2, RetailPrice, lineNumber2, Applied_Dates);
	...
	public void UpdatetheRequesttoDoubleLines(String ClubId, String ClubId2, int RetailPrice, String lineNumber,
	...
	public void POST_the_request_for_Double_lines() {
	...
	public void POST_the_emulator_request_for_Double_lines() {
