...
public class BusinessBaseAddOnComplimentaryPromotionsDoubleLinesStepDef extends BaseStep {
	...
	public BusinessBaseAddOnComplimentaryPromotionsDoubleLinesStepDef() throws IOException {
		super();
	}
	...
	@Given("^DataPower with (.*),(\\d+),(\\d+) and (\\d+) with (\\d+) and Single OrderLine (\\d+) and Double Order Line (\\d+) in (.*) to be Utilised to Get Offer for Business Base AddOn Complimentary Member$")
	public void createthesingleLineRequestBusinessBaseAddOnComplimentary(String channelName, String ClubId, String ClubId2, int code,
		...
		while (i < size) {
			...
			UpdatetheRequesttoDoubleLinesBusinessBaseAddOnComplimentary(ClubId, ClubId2, RetailPrice, lineNumber2, Applied_Dates);

			POST_the_request_for_Double_linesBusinessBaseAddOnComplimentary();
			Getparameter_and_postOperation_for_Double_LinesBusinessBaseAddOnComplimentary();

			POST_the_emulator_request_for_Double_linesBusinessBaseAddOnComplimentary();
			Getemulatorparameter_and_postOperation_for_Double_linesBusinessBaseAddOnComplimentary();

			ChecktheResultsdoubleLinesBusinessBaseAddOnComplimentary();
	...
	@Given("^DataPower with Second Item and (\\d+),(\\d+) with (\\d+) and Second OrderLine (\\d+) in (.*) to be Utilised to Get Offer for Business Base AddOn Complimentary Member$")

	public void UpdatetheRequesttoDoubleLinesBusinessBaseAddOnComplimentary(String ClubId, String ClubId2, int RetailPrice,
	...
	public void POST_the_request_for_Double_linesBusinessBaseAddOnComplimentary() {
	...
	public void POST_the_emulator_request_for_Double_linesBusinessBaseAddOnComplimentary() {
	...
	public void Getparameter_and_postOperation_for_Double_LinesBusinessBaseAddOnComplimentary() {
	...
	public void Getemulatorparameter_and_postOperation_for_Double_linesBusinessBaseAddOnComplimentary() {
	...
	public void ChecktheResultsdoubleLinesBusinessBaseAddOnComplimentary() throws Exception {
