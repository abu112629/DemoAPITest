...
public class SavingsPlusAddOnComplimentaryPromotionsStepDef extends BaseStep {
	...
	public SavingsPlusAddOnComplimentaryPromotionsStepDef() throws IOException {
		super();
	}
	...
	@Given("^Minimum required for DataPower with (.*),(\\d+),(\\d+) and (\\d+) with (\\d+) and Single OrderLine (\\d+) in (.*) to be Utilised to Get Offer for Savings AddOn Complimentary Plus Member$")
	public void createtheRequestSavingsPlusAddOnComplimentary(String channelName, String ClubId, String ClubId2, int code,
		...
		while (i < size) {
			...
			POST_the_requestSavingsPlusAddOnComplimentary();
			Getparameter_and_postOperationSavingsPlusAddOnComplimentary();

			POST_the_emulator_requestSavingsPlusAddOnComplimentary();
			Getemulatorparameter_and_postOperationSavingsPlusAddOnComplimentary();

			ChecktheResultsSavingsPlusAddOnComplimentary();
	...
	@When("^Post request to DataPower Endpoint for Savings AddOn Complimentary Plus Member$")
	public void POST_the_requestSavingsPlusAddOnComplimentary() {
	...
	@When("^Post request to Emulator Endpoint for Savings AddOn Complimentary Plus Member$")
	public void POST_the_emulator_requestSavingsPlusAddOnComplimentary() {
	...
	@When("^Request posted to DataPower and get the required discount for Savings AddOn Complimentary Plus Member$")
	public void Getparameter_and_postOperationSavingsPlusAddOnComplimentary() {

		response = thisRequestSpecification.post(UrlConstants.SERVICES_CHECKOUT).then();

	}

	@When("^Request posted to Emulator and get the required discount for Savings AddOn Complimentary Plus Member$")
	public void Getemulatorparameter_and_postOperationSavingsPlusAddOnComplimentary() {

		response2 = thisRequestSpecification2.post(UrlConstants.RESERVE_EMULATION).then();

	}

	@Then("^Assert required to DataPower and get attributes for Savings AddOn Complimentary Plus Member$")
	public void ChecktheResultsSavingsPlusAddOnComplimentary() throws Exception {
