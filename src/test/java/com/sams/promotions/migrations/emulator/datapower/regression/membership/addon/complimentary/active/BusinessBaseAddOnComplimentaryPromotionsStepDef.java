...
public class BusinessBaseAddOnComplimentaryPromotionsStepDef extends BaseStep {
	...
	public BusinessBaseAddOnComplimentaryPromotionsStepDef() throws IOException {
		super();
	}
	...
	@Given("^Minimum required for DataPower with (.*),(\\d+),(\\d+) and (\\d+) with (\\d+) and Single OrderLine (\\d+) in (.*) to be Utilised to Get Offer for Business Base AddOn Complimentary Member$")
	public void createtheRequestBusinessBaseAddOnComplimentary(String channelName, String ClubId, String ClubId2, int code, int RetailPrice,
		...
		while (i < size) {
			...
			POST_the_requestBusinessBaseAddOnComplimentary();
			Getparameter_and_postOperationBusinessBaseAddOnComplimentary();

			POST_the_emulator_requestBusinessBaseAddOnComplimentary();
			Getemulatorparameter_and_postOperationBusinessBaseAddOnComplimentary();

			ChecktheResultsBusinessBaseAddOnComplimentary();
	...
	public void POST_the_requestBusinessBaseAddOnComplimentary() {
	...
	public void POST_the_emulator_requestBusinessBaseAddOnComplimentary() {
	...
	public void Getparameter_and_postOperationBusinessBaseAddOnComplimentary() {
	...
	public void Getemulatorparameter_and_postOperationBusinessBaseAddOnComplimentary() {
	...
	public void ChecktheResultsBusinessBaseAddOnComplimentary() throws Exception {
