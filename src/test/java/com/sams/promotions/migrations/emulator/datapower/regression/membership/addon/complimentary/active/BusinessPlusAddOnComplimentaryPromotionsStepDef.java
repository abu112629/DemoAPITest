...
public class BusinessPlusAddOnComplimentaryPromotionsStepDef extends BaseStep {
	...
	public BusinessPlusAddOnComplimentaryPromotionsStepDef() throws IOException {
		super();
	}
	...
	@Given("^Minimum required for DataPower with (.*),(\\d+),(\\d+) and (\\d+) with (\\d+) and Single OrderLine (\\d+) in (.*) to be Utilised to Get Offer for Business AddOn Complimentary Plus Member$")
	public void createtheRequestBusinessPlusAddOnComplimentary(String channelName, String ClubId, String ClubId2, int code,
		...
		while (i < size) {
			...
			POST_the_requestBusinessPlusAddOnComplimentary();
			Getparameter_and_postOperationBusinessPlusAddOnComplimentary();

			POST_the_emulator_requestBusinessPlusAddOnComplimentary();
			Getemulatorparameter_and_postOperationBusinessPlusAddOnComplimentary();

			ChecktheResultsBusinessPlusAddOnComplimentary();
	...
	public void Getparameter_and_postOperationBusinessPlusAddOnComplimentary() {
	...
	public void Getemulatorparameter_and_postOperationBusinessPlusAddOnComplimentary() {
	...
	public void ChecktheResultsBusinessPlusAddOnComplimentary() throws Exception {
