  ...
  public class BusinessPlusComplimentaryPromotionsDoubleLinesStepDef extends
  BaseStep {
  
  protected String postdata, postdata2, arrx, arry, packagecode, packagecode2;
  protected String pathsingle,OfferId,OfferId2; protected String
  membershipNbr,complimentarymembershipNbr; private Response
  membershipResponse; protected String expected; protected int i, ItemId,
  ItemId2, Quantity, Quantity2, disc, disc2; protected Map<String, String>
  promodetails, promodetails2,postRequestDetails,postDoubleRequestDetails;
  
  private SoftAssertions softAssertions;
  
  public BusinessPlusComplimentaryPromotionsDoubleLinesStepDef() throws
  IOException { super(); }
  ...
  @Given("^DataPower with (.*),(\\d+),(\\d+) and (\\d+) with (\\d+) and Single OrderLine (\\d+) and Double Order Line (\\d+) in (.*) to be Utilised to Get Offer for Business Plus Complimentary Member$"
  ) public void createthesingleLineRequestBusinessComplimentaryPlus(String
  channelName, String ClubId, String ClubId2, int code, int RetailPrice, String
  lineNumber, String lineNumber2, String Applied_Dates) throws Exception {
  ...
  complimentarymembershipNbr=membership.membershipComplimentary(
  MembershipConstants.MEMBERSHIP_SAVINGS_PLUS_REQUEST_PATH, membershipNbr);
  ...
  complimentarymembershipNbr, channelName, ClubId, ClubId2, code, RetailPrice,
  lineNumber, Applied_Dates, OfferId, OfferId2, pathsingle);
  ...
  UpdatetheRequesttoDoubleLinesBusinessComplimentaryPlus(ClubId, ClubId2,
  RetailPrice, lineNumber2, Applied_Dates);
  
  POST_the_request_for_Double_linesBusinessComplimentaryPlus();
  Getparameter_and_postOperation_for_Double_LinesBusinessComplimentaryPlus();
  
  POST_the_emulator_request_for_Double_linesBusinessComplimentaryPlus();
  Getemulatorparameter_and_postOperation_for_Double_linesBusinessComplimentaryPlus
  ();
  
  ChecktheResultsdoubleLinesBusinessComplimentaryPlus();
  ...
  @Given("^DataPower with Second Item and (\\d+),(\\d+) with (\\d+) and Second OrderLine (\\d+) in (.*) to be Utilised to Get Offer for Business Plus Complimentary Member$"
  )
  
  public void UpdatetheRequesttoDoubleLinesBusinessComplimentaryPlus(String
  ClubId, String ClubId2, int RetailPrice, String lineNumber, String
  Applied_Dates) throws Exception {
  
  postDoubleRequestDetails=primaryrequest.getBusinessPlusPostRequestDetails(
  ...
  @When("^DataPower Endpoint POST request for Business Plus Complimentary Member$"
  ) public void POST_the_request_for_Double_linesBusinessComplimentaryPlus() {
  ...
  @When("^Response for DataPower and get the required discount for Business Plus Complimentary Member$"
  ) public void
  Getparameter_and_postOperation_for_Double_LinesBusinessComplimentaryPlus() {
  ...
  @When("^Response for Emulator and get the required discount for Business Plus Complimentary Member$"
  ) public void
  Getemulatorparameter_and_postOperation_for_Double_linesBusinessComplimentaryPlus
  () {
  ...
  @Then("^Assert on DataPower request and get attributes for Business Plus Complimentary Member$"
  ) public void ChecktheResultsdoubleLinesBusinessComplimentaryPlus() throws
  Exception {
  
  softAssertions=asserthelper.BusinessPlusDoubleLinesValidation(response,
