...
public class BusinessPlusComplimentaryPromotionsDoubleLinesStepDef extends BaseStep {
	...
	public BusinessPlusComplimentaryPromotionsDoubleLinesStepDef() throws IOException {
		super();
	}
	...
	public void createthesingleLineRequestBusinessComplimentaryPlus(String channelName, String ClubId, String ClubId2, int code,
		...
		complimentarymembershipNbr=membership.membershipComplimentary(MembershipConstants.MEMBERSHIP_SAVINGS_PLUS_REQUEST_PATH,
				membershipNbr);
		...
		while (i < size) {
			...
			UpdatetheRequesttoDoubleLinesBusinessComplimentaryPlus(ClubId, ClubId2, RetailPrice, lineNumber2, Applied_Dates);
	...
	public void UpdatetheRequesttoDoubleLinesBusinessComplimentaryPlus(String ClubId, String ClubId2, int RetailPrice,
			String lineNumber, String Applied_Dates) throws Exception {

		postDoubleRequestDetails=primaryrequest.getBusinessPlusPostRequestDetails(disc, disc2, packagecode, 
	...
	public void Getparameter_and_postOperation_for_Double_LinesBusinessComplimentaryPlus() {
	...
	public void Getemulatorparameter_and_postOperation_for_Double_linesBusinessComplimentaryPlus() {
	...
	public void ChecktheResultsdoubleLinesBusinessComplimentaryPlus() throws Exception {

		softAssertions=asserthelper.BusinessPlusDoubleLinesValidation(response, response2, packagecode, packagecode2, OfferId, OfferId2, expected);
