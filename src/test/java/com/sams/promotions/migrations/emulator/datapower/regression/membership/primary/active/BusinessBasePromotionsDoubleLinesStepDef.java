...
import
        com.sams.promotions.emulation.test.helper.Helper;
import
        com.sams.promotions.emulation.test.helper.PrimaryRequestHelper;
import
        com.sams.promotions.emulation.test.helper.ReserveEmulationHelper;
import
...
public class BusinessBasePromotionsDoubleLinesStepDef extends BaseStep {
    ...
    protected
    String pathsingle, OfferId, OfferId2;
    protected String membershipNbr;
    private
    Response membershipResponse;
    protected String expected;
    protected int i, disc,
            disc2;
    ...
    public void createthesingleLineRequestBusinessBase(String channelName,
        ...
        membershipResponse = membership.createPRIMARYMembership(MembershipConstants.
                MEMBERSHIP_BUSINESS_REQUEST_PATH);
        membershipNbr =
        ...
        while (i < size) {
            ...
            UpdatetheRequesttoDoubleLinesBusinessBase(ClubId, ClubId2, RetailPrice,
    ...
    public void UpdatetheRequesttoDoubleLinesBusinessBase(String ClubId, String
