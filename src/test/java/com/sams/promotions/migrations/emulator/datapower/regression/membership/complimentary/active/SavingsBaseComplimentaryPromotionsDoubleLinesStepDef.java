  ...
  public class SavingsBaseComplimentaryPromotionsDoubleLinesStepDef extends
  BaseStep {
  ...
  public SavingsBaseComplimentaryPromotionsDoubleLinesStepDef() throws
  IOException { super(); }
  ...
  @Given("^DataPower with (.*),(\\d+),(\\d+) and (\\d+) with (\\d+) and Single OrderLine (\\d+) and Double Order Line (\\d+) in (.*) to be Utilised to Get Offer for Complimentary Member$"
  ) public void createthesingleLineComplimentaryRequest(String channelName,
  String ClubId, String ClubId2, int code, int RetailPrice, String lineNumber,
  String lineNumber2, String Applied_Dates) throws Exception {
  ...
  MembershipConstants.MEMBERSHIP_SAVINGS_BASE_REQUEST_PATH, membershipNbr);
  ...
  UpdatetheRequesttoDoubleLinesComplimentary(ClubId, ClubId2, RetailPrice,
  lineNumber2, Applied_Dates);
  ...
  @Given("^DataPower with Second Item and (\\d+),(\\d+) with (\\d+) and Second OrderLine (\\d+) in (.*) to be Utilised to Get Offer for Complimentary Member$"
  )
  
  public void UpdatetheRequesttoDoubleLinesComplimentary(String ClubId, String
  ClubId2, int RetailPrice, String lineNumber, String Applied_Dates) throws
  Exception {
  ...
  @When("^DataPower Endpoint POST request for Complimentary Member$") public
  void POST_the_request_for_Double_linesComplimentary() {
  ...
  @When("^Post the request to Emulator Endpoint for Complimentary Member$")
  ...
  @When("^Response for DataPower and get the required discount for Complimentary Member$"
  ...
  @When("^Response for Emulator and get the required discount for Complimentary Member$"
  ) public void
  Getemulatorparameter_and_postOperation_for_Double_linesComplimentary() {
  ...
  @Then("^Assert on DataPower request and get attributes for Complimentary Member$"
