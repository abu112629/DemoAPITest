...
public class SavingsBaseComplimentaryPromotionsDoubleLinesStepDef extends BaseStep {
	...
	public SavingsBaseComplimentaryPromotionsDoubleLinesStepDef() throws IOException {
		super();
	}
	...
	public void createthesingleLineComplimentaryRequest(String channelName, String ClubId, String ClubId2, int code, int RetailPrice,
		...
		while (i < size) {
			...
			UpdatetheRequesttoDoubleLinesComplimentary(ClubId, ClubId2, RetailPrice, lineNumber2, Applied_Dates);
	...
	public void UpdatetheRequesttoDoubleLinesComplimentary(String ClubId, String ClubId2, int RetailPrice, String lineNumber,
	...
	@When("^DataPower Endpoint POST request for Complimentary Member$")
