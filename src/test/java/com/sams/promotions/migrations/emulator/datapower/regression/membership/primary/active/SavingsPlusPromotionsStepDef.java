...
public class SavingsPlusPromotionsStepDef extends BaseStep {
	...
	public SavingsPlusPromotionsStepDef() throws IOException {
		super();
	}
	...
	@Given("^Minimum required for DataPower with (.*),(\\d+),(\\d+) and (\\d+) with (\\d+) and Single OrderLine (\\d+) in (.*) to be Utilised to Get Offer for Savings Primary Plus Member$")
	public void createtheRequestSavingsPlus(String channelName, String ClubId, String ClubId2, int code,
		...
		while (i < size) {
			...
			POST_the_requestSavingsPlus();
			Getparameter_and_postOperationSavingsPlus();

			POST_the_emulator_requestSavingsPlus();
			Getemulatorparameter_and_postOperationSavingsPlus();

			ChecktheResultsSavingsPlus();
	...
	public void POST_the_requestSavingsPlus() {
	...
	public void POST_the_emulator_requestSavingsPlus() {
	...
	public void Getparameter_and_postOperationSavingsPlus() {
	...
	public void Getemulatorparameter_and_postOperationSavingsPlus() {
	...
	public void ChecktheResultsSavingsPlus() throws Exception {
