...
public class EmulatorRegressionPromotionsStepDef extends BaseStep {
	...
	@Given("^Minimum (\\d+) required for Emulator with (.*),(\\d+),(\\d+) and (\\d+) with (\\d+) and Single OrderLine (\\d+) in (.*) to be Utilised to Get Offer (.*) for AddOn Complimentary Member$")
	...
	@Given("^Minimum (\\d+) required for Emulator with Second (\\d+) and (\\d+) with (\\d+) and Second OrderLine (\\d+) to be Utilised to Get Offer for AddOn Complimentary Member$")
	...
	@When("^Post request to Emulator Endpoint for AddOn Complimentary Member$")
	...
	@When("^Request posted to Emulator and get the required discount for AddOn Complimentary Member$")
	...
	@Then("^Assert required to Emulator and get attributes for AddOn Complimentary Member$")
