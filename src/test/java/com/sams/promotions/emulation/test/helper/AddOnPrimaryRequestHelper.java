...
public class AddOnPrimaryRequestHelper {
	...
	public Map<String,String> getBusinessBaseAddOnPostRequestDetails(int disc,int disc2,String packagecode,String packagecode2,
	...
	public Map<String,String> getBusinessPlusAddOnPostRequestDetails(int disc,int disc2,String packagecode,String packagecode2,
			String ClubId, String ClubId2,int RetailPrice,String lineNumber, String Applied_Dates, 
			String OfferId,String OfferId2,String postdata,String postdata2) throws Exception {
	...
	public Map<String,String> getSavingsBaseAddOnPostRequestDetails(int disc,int disc2,String packagecode,String packagecode2,
			String ClubId, String ClubId2,int RetailPrice,String lineNumber, String Applied_Dates, 
			String OfferId,String OfferId2,String postdata,String postdata2) throws Exception {
	...
	public Map<String,String> getSavingsPlusAddOnPostRequestDetails(int disc,int disc2,String packagecode,String packagecode2,
			String ClubId, String ClubId2,int RetailPrice,String lineNumber, String Applied_Dates, 
			String OfferId,String OfferId2,String postdata,String postdata2) throws Exception {
