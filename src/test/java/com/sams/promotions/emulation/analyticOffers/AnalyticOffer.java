...
private Long minimumSeedPurchaseQuantity;
@JsonProperty("minimumRewardPurchaseQuantity")
private Long minimumRewardPurchaseQuantity;
...
@JsonProperty("minimumSeedPurchaseQuantity")
public Long getMinimumSeedPurchaseQuantity() {
return minimumSeedPurchaseQuantity;
}

@JsonProperty("minimumSeedPurchaseQuantity")
public void setMinimumSeedPurchaseQuantity(Long minimumSeedPurchaseQuantity) {
this.minimumSeedPurchaseQuantity = minimumSeedPurchaseQuantity;
}

@JsonProperty("minimumRewardPurchaseQuantity")
public Long getMinimumRewardPurchaseQuantity() {
return minimumSeedPurchaseQuantity;
}

@JsonProperty("minimumRewardPurchaseQuantity")
public void setMinimumRewardPurchaseQuantity(Long minimumRewardPurchaseQuantity) {
