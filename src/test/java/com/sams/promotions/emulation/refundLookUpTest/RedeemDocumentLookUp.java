...
public class RedeemDocumentLookUp {
	...
	public String ForwardSyncValidator(int index, String OrderNumber) throws Exception {
		...
		String result = connection.setRefundClient(OrderNumber);
		...
		String memberId = document.getMembershipId();
	...
	public SoftAssertions ValidationsAll(ValidatableResponse response, ValidatableResponse response2) throws Exception {
		...
		if (res.statusCode() == 200 && res2.statusCode() == 200) {
			...
			System.out.println("Legacy Refund Response :" + res.prettyPrint());
			System.out.println("QuickSilver Refund Response " + res2.prettyPrint());
