...
private MerchandiseDetails___ merchandiseDetails;
...
@JsonProperty("merchandiseDetails")
public MerchandiseDetails___ getMerchandiseDetails() {
return merchandiseDetails;
}

@JsonProperty("merchandiseDetails")
public void setMerchandiseDetails(MerchandiseDetails___ merchandiseDetails) {
