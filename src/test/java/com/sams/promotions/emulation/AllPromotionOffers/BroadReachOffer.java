...
private MerchandiseDetails_ merchandiseDetails;
...
@JsonProperty("merchandiseDetails")
public MerchandiseDetails_ getMerchandiseDetails() {
return merchandiseDetails;
}

@JsonProperty("merchandiseDetails")
public void setMerchandiseDetails(MerchandiseDetails_ merchandiseDetails) {
