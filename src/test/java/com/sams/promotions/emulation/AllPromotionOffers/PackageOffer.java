...
private MerchandiseDetails__ merchandiseDetails;
...
@JsonProperty("merchandiseDetails")
public MerchandiseDetails__ getMerchandiseDetails() {
return merchandiseDetails;
}

@JsonProperty("merchandiseDetails")
public void setMerchandiseDetails(MerchandiseDetails__ merchandiseDetails) {
